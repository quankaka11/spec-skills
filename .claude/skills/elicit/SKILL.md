...
- `${CLAUDE_PROJECT_DIR}/knowledge/20-ngan-hang-cau-hoi.md`: §1 (10 quy tắc hỏi), §2 (ngân hàng câu theo ID), §3 (6 lượt batch sẵn + ngân sách % token), §4 (30 phát biểu Đúng/Sai), §5 (mẫu RTM), §6 (mẫu log).
...
- Quá 8 câu một lượt; bỏ N1-02 (NGOÀI phạm vi) trước 11:00.
