...
| Lớp | Ở đâu | Vai trò |
|---|---|---|
| Tri thức | `knowledge/00…50-*.md` | 7 file chưng cất từ mô tả cuộc thi + 16 PDF (ISTQB, DMN, NASA, Volere, Berry ambiguity, BABOK, Shopify/IBM/Oracle inventory). Skill chỉ dẫn "đọc file X mục Y", không chép lại. |
...
| Giờ | Lệnh | Vào | Ra |
|---|---|---|---|
| 9:30–11:00 | `/elicit lượt 1` … `lượt 6`, sau mỗi câu trả lời `/elicit nạp` + dán | `battle/brief.md` | Khối prompt copy-paste; `battle/log-khach-hang.md` (timestamp, nguyên văn); `battle/rtm.md` (RTM ngược, ⚠) |
| 11:00–11:45 | `/spec-write` | `rtm.md`, log | `battle/spec.md` ≤3.000 từ, mọi BR truy vết `← A-xx`; RTM điền Mã BR |
