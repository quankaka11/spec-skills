...
| **Cấu trúc spec nộp** | **10 mục kiểu thiết kế Nhật**: 基本設計 mục 1–5 (*theo màn hình*) · 詳細設計 mục 6–9 (*theo chức năng*) · 技術仕様 mục 10. Chi tiết: knowledge/32 | **Tài liệu BTC 11/09** ("Spec Battle Anatomy") |
...
8. **Mục 5 (Design / Wireframe) nộp thế nào khi không có Figma — Mermaid `block-beta` có được chấp nhận không?** (tài liệu 11/09 yêu cầu mục 5 nhưng bản nộp không có ảnh.)
9. Sơ đồ mermaid có tính vào 6.000 token như văn bản thường không?

Ô 1 và 2 đổi kế hoạch buổi sáng; hỏi trước 9:30. **Ô 8 và 9 đổi cách viết mục 5 và ngân sách token — hỏi trước 10:20.** Các ô còn lại chỉ đổi cách tính điểm kỳ vọng, hỏi lúc nào cũng được.

> **Thứ tự hai nguồn tham số:** họp BTC 09/09 chốt hạn mức, cách hỏi và điểm (§A). Tài liệu "Spec Battle Anatomy" 11/09 chốt **cấu trúc 10 mục** của bản nộp (knowledge/32) — nó đến *sau* họp, và **không đổi** tham số nào ở §A. Khi hai nguồn cùng nói về một thứ, lấy nguồn muộn hơn.
...
| Red Teamer | M5 lạm dụng, M6 suy biến, bảng mâu thuẫn brief | **Cổng F (33 §1)** + bảng Mục tiêu↔Luật + eval set **hai reader** + lint 22 nhóm (40) + cổng chất lượng **16 dòng** (30 §7) + **xếp hạng rủi ro giả định để nuôi câu 5** | Soi spec #3, bảng đồng thuận chéo, tổng hợp 15 hồ sơ 50 §7 |
