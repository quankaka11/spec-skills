...
| **F7** | Phục vụ mục tiêu | Luật này thuộc cột 2 hay cột 3 của bảng Mục tiêu↔Luật (05 §2)? | Ở cột 3 (làm hỏng mục tiêu), hoặc không ở cột nào | Cột 3 ⇒ hỏi AI Khách hàng ngay, đây gần chắc là chỗ specs thật có luật riêng. Không ở cột nào ⇒ ứng viên cắt đầu tiên nếu vượt hạn mức `L` |
